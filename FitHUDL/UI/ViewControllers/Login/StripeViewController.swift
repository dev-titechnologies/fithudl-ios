...
//  
//
//  Created by Ti Technologies on 18/04/16.
//
//
...
class StripeViewController: UIViewController {
    ...
    */
    ...
    @IBAction func questionButtonAction(sender: AnyObject) {
        ...
        UIAlertView(title: alertTitle, message: "You need a stripe account to get paid every week, for training! Do not worry, we don't store your bank details anywhere. Stripe is secure enough to handle this.", delegate: self, cancelButtonTitle: "OK").show()
